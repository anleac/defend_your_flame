...
class SpriteManager {
  ...
  static SpriteAnimation getAnimation(String name, {required int frames, required double stepTime, bool loop = true}) {
    var image = Flame.images.fromCache(_fixName(name));
    var srcSize = Vector2(image.width / frames, image.height.toDouble());

    return SpriteAnimation.fromFrameData(
        image, SpriteAnimationData.sequenced(amount: frames, stepTime: stepTime, textureSize: srcSize, loop: loop));
  }
